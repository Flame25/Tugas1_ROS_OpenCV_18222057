...
(cl:defmethod cl:initialize-instance :after ((m <modifyText-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'modifyText-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_package-srv:<modifyText-request> is deprecated: use testing_package-srv:modifyText-request instead.")))

(cl:ensure-generic-function 'inputString-val :lambda-list '(m))
(cl:defmethod inputString-val ((m <modifyText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_package-srv:inputString-val is deprecated.  Use testing_package-srv:inputString instead.")
  (inputString m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<modifyText-request>)))
  ...
  "testing_package/modifyTextRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'modifyText-request)))
  "Returns string type for a service object of type 'modifyText-request"
  "testing_package/modifyTextRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <modifyText-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'modifyText-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_package-srv:<modifyText-response> is deprecated: use testing_package-srv:modifyText-response instead.")))

(cl:ensure-generic-function 'modifiedString-val :lambda-list '(m))
(cl:defmethod modifiedString-val ((m <modifyText-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_package-srv:modifiedString-val is deprecated.  Use testing_package-srv:modifiedString instead.")
  (modifiedString m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<modifyText-response>)))
  ...
  "testing_package/modifyTextResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'modifyText-response)))
  "Returns string type for a service object of type 'modifyText-response"
  "testing_package/modifyTextResponse")
